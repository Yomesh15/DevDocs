...
const Login = () => {
    ...
    const googleauth = async () => {
        try {
            ...
            await axios.post(`${import.meta.env.VITE_BACKEND}/auth/google-auth`, { idToken }, { withCredentials: true })
    ...
    const loginviainput = async (e) => {
        e.preventDefault()

        setloading(true)

        try {
            const res = await axios.post(`${import.meta.env.VITE_BACKEND}/auth/login`, form, { withCredentials: true })
                ...
                <div className="hidden lg:flex relative overflow-hidden bg-gradient-to-br from-indigo-600/20 via-purple-600/20 to-cyan-500/20 p-14">
                    ...
                    <div className="relative z-10 flex flex-col justify-center text-white">
                        ...
                        <p className="mt-6 text-lg text-gray-400 leading-8">
                            Sign in to continue collaborating on documents in real time.
                            Pick up right where you left off with your team.
                        </p>
                ...
                <div className="flex items-center justify-center p-8 sm:p-12">
                    <div className="w-full max-w-md">
                        ...
                        <p className="mt-8 text-center text-gray-400">
                            ...
                            <Link
                                to="/register"
                                className="font-semibold cursor-pointer text-indigo-400 hover:text-indigo-300 hover:underline"
                            >
                                Create Account
                            </Link>
                        </p>
